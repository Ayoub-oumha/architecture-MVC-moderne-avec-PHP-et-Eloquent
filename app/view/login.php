...
<body class="bg-gray-100 flex items-center justify-center h-screen">
    <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-sm">
        ...
        <form action="/login" method="POST" class="space-y-4">
            ...
            <div class="w-full">
                <a href="/register" class="block text-center w-full bg-indigo-600 text-white py-2 px-4 rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">Register</a>
            </div>
        </form>
    </div>
</body>
